...
plot(res.mca,invisible=c("ind"),col.var=c(c("blue", "purple", "red"), rep("black",30)),axes=c(1,3),title="Graph of the playing style performance")
```
